#include "w_rpt_report_frame_periodbusiness.h"
#include "w_rpt_report_frame_periodbusiness.h"
#include "ui_w_rpt_report_frame_periodbusiness.h"
...
w_rpt_report_frame_periodbusiness::w_rpt_report_frame_periodbusiness(QWidget *parent) :
    w_rpt_report_frame(QStringList(), parent)
{
    ui_help = new Ui::w_rpt_report_frame_periodbusiness;
...
w_rpt_report_frame_periodbusiness::~w_rpt_report_frame_periodbusiness()
{
    delete ui_help;
}

void w_rpt_report_frame_periodbusiness::toselect()
{
