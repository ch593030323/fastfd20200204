#include "w_rpt_report_frame_servantpromotion.h"
#include "w_rpt_report_frame_servantpromotion.h"
#include "ui_w_rpt_report_frame_servantpromotion.h"
...
w_rpt_report_frame_servantpromotion::w_rpt_report_frame_servantpromotion(QWidget *parent) :
    w_rpt_report_frame(QStringList(), parent)
{
    ui_help = new Ui::w_rpt_report_frame_servantpromotion;
...
w_rpt_report_frame_servantpromotion::~w_rpt_report_frame_servantpromotion()
{
    delete ui_help;
}

void w_rpt_report_frame_servantpromotion::toselect()
{
