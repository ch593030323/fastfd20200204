#include "w_rpt_report_frame_tablebusiness.h"
#include "w_rpt_report_frame_tablebusiness.h"
#include "ui_w_rpt_report_frame_tablebusiness.h"
...
w_rpt_report_frame_tablebusiness::w_rpt_report_frame_tablebusiness(QWidget *parent) :
    w_rpt_report_frame(QStringList(), parent)
{
    ui_help = new Ui::w_rpt_report_frame_tablebusiness;
...
w_rpt_report_frame_tablebusiness::~w_rpt_report_frame_tablebusiness()
{
    delete ui_help;
}

void w_rpt_report_frame_tablebusiness::toselect()
{
