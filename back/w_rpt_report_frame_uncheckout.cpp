#include "w_rpt_report_frame_uncheckout.h"
#include "w_rpt_report_frame_uncheckout.h"
...
w_rpt_report_frame_uncheckout::w_rpt_report_frame_uncheckout(QWidget *parent) :
    w_rpt_report_frame(QStringList(), parent)
{
    ui_help = new Ui::w_rpt_report_frame_uncheckout;
...
w_rpt_report_frame_uncheckout::~w_rpt_report_frame_uncheckout()
{
    delete ui_help;
}

void w_rpt_report_frame_uncheckout::toselect()
{
