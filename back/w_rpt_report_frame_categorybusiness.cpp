#include "w_rpt_report_frame_categorybusiness.h"
#include "w_rpt_report_frame_categorybusiness.h"
#include "ui_w_rpt_report_frame_categorybusiness.h"
...
w_rpt_report_frame_categorybusiness::w_rpt_report_frame_categorybusiness(QWidget *parent) :
    w_rpt_report_frame(QStringList(), parent)
{
    ui_help = new Ui::w_rpt_report_frame_categorybusiness;
...
w_rpt_report_frame_categorybusiness::~w_rpt_report_frame_categorybusiness()
{
    delete ui_help;
}

void w_rpt_report_frame_categorybusiness::toselect()
{
