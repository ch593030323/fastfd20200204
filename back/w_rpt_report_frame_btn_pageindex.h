#ifndef W_RPT_REPORT_FRAME_BTN_PAGEINDEX_H
#define W_RPT_REPORT_FRAME_BTN_PAGEINDEX_H

#include "lds_toolbar_button.h"
#include <QMap>
#include <QSet>
class w_rpt_report_frame_btn_pageindex : public lds_toolbar_button
{
    Q_OBJECT
public:
...
public:
    w_rpt_report_frame_btn_pageindex(QWidget *parent);
...
#endif // W_RPT_REPORT_FRAME_BTN_PAGEINDEX_H
