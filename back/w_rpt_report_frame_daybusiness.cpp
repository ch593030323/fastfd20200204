#include "w_rpt_report_frame_daybusiness.h"
#include "ui_w_rpt_report_frame_daybusiness.h"
...
w_rpt_report_frame_daybusiness::w_rpt_report_frame_daybusiness(QWidget *parent) :
    w_rpt_report_frame(QStringList(), parent)
{
    ui_help = new Ui::w_rpt_report_frame_daybusiness;
...
w_rpt_report_frame_daybusiness::~w_rpt_report_frame_daybusiness()
{
    delete ui_help;
}

void w_rpt_report_frame_daybusiness::toselect()
{
