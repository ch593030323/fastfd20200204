#include "w_rpt_report_frame_daymothweek.h"
#include "ui_w_rpt_report_frame_daymothweek.h"
...
w_rpt_report_frame_daymothweek::w_rpt_report_frame_daymothweek(QWidget *parent) :
    w_rpt_report_frame(QStringList(), parent)
{
    ui_help = new Ui::w_rpt_report_frame_daymothweek;
...
w_rpt_report_frame_daymothweek::~w_rpt_report_frame_daymothweek()
{
    delete ui_help;
}

void w_rpt_report_frame_daymothweek::toselect()
{
